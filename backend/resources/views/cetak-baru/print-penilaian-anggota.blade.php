...
<head>
    ...
    <meta charset="UTF-8">
    <title>Format Penilaian Anggota - {{ $ruangan->nama_ruangan }}</title>
...
<body onload="window.print()">
    ...
    <div class="kop-surat">
        ...
        <div class="kop-right">
            <h1>FORMAT PENILAIAN / DAFTAR NILAI HARIAN</h1>
            ...
            <p>Mata Pelajaran: ................................................................ Guru Pengampu:
                ................................................................</p>
        </div>
    </div>

    <!-- Tabel Lembar Nilai Anggota Kelas -->
    <table class="data-table">
        <thead>
            <tr>
                <th rowspan="2" style="width: 25px;">No</th>
                <th rowspan="2" style="width: 55px;">NISM</th>
                <th rowspan="2" style="width: 180px; text-align: left; padding-left: 8px;">Nama Lengkap Murid</th>
                <th rowspan="2" style="width: 25px;">L/P</th>
                <th colspan="5">Tugas Harian / Muhafazhah</th>
                <th colspan="3">Ujian Formatif</th>
                <th rowspan="2" style="width: 45px;">Nilai Akhir</th>
                <th rowspan="2" style="width: 70px;">Keterangan</th>
            </tr>
            <tr>
                <th style="width: 35px;">T1</th>
                <th style="width: 35px;">T2</th>
                <th style="width: 35px;">T3</th>
                <th style="width: 35px;">T4</th>
                <th style="width: 35px;">T5</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="14" class="text-center" style="padding: 20px;">Tidak ada data murid di ruangan ini.
                    </td>
                </tr>
            @endforelse
        </tbody>
    ...
    <div style="font-size: 9px; color: #64748b; font-style: italic; margin-top: -5px;">
        *Catatan: Nilai dimasukkan dengan skala 0 - 100. Rekap nilai ini diserahkan kepada Wali Ruangan di setiap akhir
        semester.
    </div>
    ...
    <table class="signature-table">
        <tr>
            <td style="width: 50%;">
                ...
                <p style="margin: 2px 0 6px 0; font-size: 11px; font-weight: bold;">Wali Ruangan / Pengasuh</p>
                ...
                <p
                    ...
                    {{ $waliUstadz?->nama_lengkap ?? ($pengasuh?->anggota?->nama_lengkap ?? 'Nama Wali Ruangan Belum Diatur') }}
                </p>
            </td>
            ...
            <td style="width: 50%;">
                ...
                <p style="margin: 2px 0 6px 0; font-size: 11px; font-weight: bold;">Guru Pengampu Mata Pelajaran</p>
